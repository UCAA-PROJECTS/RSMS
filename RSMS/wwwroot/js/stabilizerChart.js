...
function updateChartData(range) {
    ...
    if (humidityChart && config) {
        humidityChart.data.labels = config.labels;
        humidityChart.data.datasets[0].data = config.data;
        humidityChart.options.scales.x.ticks.autoSkip = config.autoSkip;
