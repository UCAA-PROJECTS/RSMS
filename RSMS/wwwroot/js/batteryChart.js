...
function updateChartData(range) {
    ...
    if (batteryChart && config) {
        batteryChart.data.labels = config.labels;
        batteryChart.data.datasets[0].data = config.data;
        batteryChart.options.scales.x.ticks.autoSkip = config.autoSkip;
        batteryChart.update();
    }
}
